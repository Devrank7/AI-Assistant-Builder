...
import { MessageCircle, X, Send, Trash2, Sparkles, Mic, MicOff, ChevronDown, Phone, Mail, Globe, MoreVertical, ArrowDown, Type, Download, Volume2, VolumeX } from 'lucide-preact';
                ...
                {(!isMobile || !isOpen) && (
                    <div className="relative self-end">
                        {!isOpen && unreadCount > 0 && (
                            <span className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#3b82f6] to-[#1e40af] animate-pulse-ring" />
                        )}
                        <motion.button
                            ...
                            className={`w-[58px] h-[58px] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#3b82f6]/30 bg-gradient-to-br from-[#3b82f6] via-[#2563eb] to-[#1e40af] border border-white/10 ${!isOpen ? 'animate-breathe' : ''}`}
