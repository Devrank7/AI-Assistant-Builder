...
function ChatMessage({ role, content, timestamp, isError, onRetry, imageUrl, onImageClick }) {
    ...
    return (
        ...
        >
            {/* Bot Avatar */}
            {isBot && (
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#ddf5f2] to-[#c9eeea] flex items-center justify-center flex-shrink-0 shadow-sm border border-[#a3e2db]/50">
