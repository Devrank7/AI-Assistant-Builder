...
function ChatMessage({ role, content, timestamp, isError, onRetry, imageUrl, onImageClick }) {
    ...
    return (
        ...
        >
            {/* Bot Avatar */}
            {isBot && (
                <div className="w-7 h-7 rounded-[8px] bg-gradient-to-br from-[#3a2020] to-[#4a2828] flex items-center justify-center flex-shrink-0 shadow-sm border border-[#5a3030]/50">
