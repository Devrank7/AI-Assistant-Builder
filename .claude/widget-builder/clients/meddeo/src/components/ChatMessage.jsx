...
function ChatMessage({ role, content, timestamp, isError, onRetry, imageUrl, onImageClick }) {
    ...
    return (
        ...
        >
            {/* Bot Avatar */}
            {isBot && (
                <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-[#d9f0fc] to-[#bee6f9] flex items-center justify-center flex-shrink-0 shadow-sm border border-[#7dcaf2]/50">
