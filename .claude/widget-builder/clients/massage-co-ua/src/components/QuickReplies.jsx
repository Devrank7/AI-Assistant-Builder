        ...
        <div className="flex flex-col gap-2">
            {options.map((option, idx) => (
                <motion.button
                    ...
                    className="group relative w-full rounded-2xl border overflow-hidden transition-all duration-300 cursor-pointer text-left shadow-sm hover:shadow-md bg-[#1a1d23]/80 border-[#2a2d35]/80 hover:border-[#3b82f6] hover:bg-[#1e212b] group-hover:shadow-[0_0_20px_rgba(59,130,246,0.08)]"
