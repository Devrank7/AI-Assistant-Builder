    ...
    >
      ...
      <nav className="relative z-20 flex items-center justify-between bg-white px-6 py-4 md:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/"
            className="rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-600 transition-all hover:border-[#2563EB]/30 hover:text-[#2563EB]"
          >
            Home
          </Link>
        </div>
      ...
      <footer className="border-t border-gray-100 bg-white px-6 py-8">
        <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-4 text-sm text-[#94A3B8] md:flex-row">
          ...
          <div className="flex gap-4">
            <Link href="/privacy" className="transition-colors hover:text-[#64748B]">
              Privacy
            </Link>
            <Link href="/terms" className="transition-colors hover:text-[#64748B]">
              Terms
            </Link>
