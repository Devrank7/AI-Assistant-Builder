...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebarContent = (
    <>
      <div className="flex items-center gap-2 border-b border-white/10 px-6 py-5">
        ...
        <span className="text-lg font-semibold text-white">WinBix AI</span>
      </div>
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Sidebar - mobile */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 transform flex-col border-r border-white/10 bg-[#0d0d14] transition-transform duration-200 lg:hidden ${
      ...
      {/* Sidebar - desktop */}
      <aside className="hidden border-r border-white/10 bg-[#0d0d14] lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        {sidebarContent}
      </aside>
