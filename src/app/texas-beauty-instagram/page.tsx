      ...
      <footer className="border-t border-[#B76E79]/10 bg-[#FDF8F4] px-6 py-12">
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            ...
            <a
              href="https://www.instagram.com/ai.beauty.booking/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-medium text-[#6B5B5B] transition-colors hover:text-[#B76E79]"
            >
