...
function ClientCabinetContent() {
    ...
    const verifyAndFetchData = async (token: string) => {
        try {
            ...
            // Verify token first
            const authResponse = await fetch('/api/auth/client', {
                method: 'POST',
            ...
            // Fetch client data
            const response = await fetch(`/api/clients/${authData.clientId}`);
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold gradient-text">My Cabinet</h1>
