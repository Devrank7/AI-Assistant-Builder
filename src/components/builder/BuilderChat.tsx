...
const TOOL_LABELS: Record<string, string> = {
  ...
  research_api: 'Researching API docs',
  create_integration: 'Creating integration',
  test_integration_config: 'Testing integration',
  activate_integration: 'Activating integration',
  deactivate_integration: 'Deactivating integration',
                      ...
                      <>
                        {msg.fileAttachment && (
                          ...
                          >
                            ...
                            <span className="truncate text-xs font-medium" style={{ maxWidth: '180px' }}>
                              {msg.fileAttachment.filename}
                            </span>
                            <span className="text-[10px] opacity-60">{formatFileSize(msg.fileAttachment.size)}</span>
                          </div>
                        )}
