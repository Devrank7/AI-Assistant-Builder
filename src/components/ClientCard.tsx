...
export default function ClientCard({ client }: ClientCardProps) {
  ...
  return (
    <MotionCard className="group relative h-full overflow-hidden rounded-2xl">
      ...
      <div className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--neon-cyan)]/10 via-transparent to-[var(--neon-purple)]/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      <div className="glass relative h-full border-white/[0.04] p-6 transition-colors group-hover:border-white/10 group-hover:bg-white/[0.05]">
        ...
        <div className="mb-5 flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[var(--neon-cyan)] to-[var(--neon-purple)] opacity-0 blur-md transition-opacity duration-500 group-hover:opacity-40" />
              <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--neon-cyan)] to-[var(--neon-purple)] text-lg font-bold text-white shadow-lg">
        ...
        <div className="flex items-center justify-between text-sm">
          <a
            ...
            className="relative z-20 flex items-center gap-1.5 text-gray-500 transition-colors hover:text-[var(--neon-cyan)]"
        ...
        {/* Hover CTA */}
        <div className="mt-4 flex items-center justify-center border-t border-white/[0.04] pt-4 text-gray-500 transition-all group-hover:text-[var(--neon-cyan)]">
