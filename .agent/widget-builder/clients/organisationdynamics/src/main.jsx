...
class AIChatWidget extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const fontHref = 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,700;1,300;1,700&family=Raleway:ital,wght@0,400;0,700;1,400;1,700&family=Montserrat:ital,wght@0,400';
