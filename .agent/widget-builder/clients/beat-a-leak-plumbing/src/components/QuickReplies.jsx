        ...
        <div className="flex flex-col gap-2">
            {options.map((option, idx) => (
                <motion.button
                    ...
                    className="group relative w-full rounded-2xl border overflow-hidden transition-all duration-300 cursor-pointer text-left shadow-sm hover:shadow-md bg-white/80 border-[#f4c0c2] hover:border-[#f06068] hover:bg-[#f5a0a4]/40 group-hover:shadow-[0_2px_16px_rgba(237,28,36,0.10)]"
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#ED1C24]/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                </motion.button>
            ))}
        </div>
    );
