...
class AIChatWidget extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const fontHref = 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,300;0,400;0,900;1,300&family=Poppins:ital,wght@0,100;0,300;0,500;0,900;1,300&display=swap';
