...
class AIChatWidget extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const fontHref = 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,500&family=Albert+Sans:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=Nunito:ital,wght@0,300;0,700;1,300;1,700';
