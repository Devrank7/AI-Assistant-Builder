    ...
    const chatContent = (
        <>
            ...
            <div className="relative px-5 py-4 flex items-center justify-between ">
                <div className="absolute inset-0 bg-gradient-to-br from-[#283593] via-[#3e499e] to-[#F9A825]" />
                ...
                {(!isMobile || !isOpen) && (
                    <div className="relative self-end">
                        {!isOpen && unreadCount > 0 && (
                            <span className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#283593] to-[#F9A825] animate-pulse-ring" />
                        )}
                        <motion.button
                            ...
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#283593]/30 bg-gradient-to-br from-[#283593] via-[#3e499e] to-[#F9A825] border border-white/10 ${!isOpen ? 'animate-breathe' : ''}`}
