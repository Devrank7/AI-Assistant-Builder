        ...
        <div className="flex flex-col gap-2">
            {options.map((option, idx) => (
                <motion.button
                    ...
                    className="group relative w-full rounded-2xl border overflow-hidden transition-all duration-300 cursor-pointer text-left shadow-sm hover:shadow-md bg-white/80 border-[#9acfed] hover:border-[#67b8e3] hover:bg-[#b3dbf1]/40 group-hover:shadow-[0_2px_16px_rgba(2,136,209,0.10)]"
                ...
                >
                    <div className="relative flex items-center gap-3 px-3.5 py-2.5">
                        ...
                        <span className="text-[12px] font-medium leading-snug text-[#0270ab]">{option}</span>
                    </div>
