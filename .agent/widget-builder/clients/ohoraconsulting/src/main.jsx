...
class AIChatWidget extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const fontHref = 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&#038;subset=latin,latin-ext';
